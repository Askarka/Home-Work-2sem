...
//        fw.write( "show() for 1000 take in average: "+ average3 / 1000  + " microseconds"+  "\n" + "\n");
        ...
        for(int i = 0; i < 100; i++){
            ...
            b = new CircleList("100.txt");
            t1 = System.nanoTime();
            b.bubbleSort("Eyfwuysbev");
            t2 = System.nanoTime();
            average1+=(t2 - t1)/100;

            t3 = System.nanoTime();
            b.sortUsingStringArray("Eyfwuysbev");
            t4 = System.nanoTime();
            average2+=(t4 - t3)/100;

            c = new CircleList("500.txt");
            t5 = System.nanoTime();
            c.bubbleSort("Fjuvbulpqa");
            t6 = System.nanoTime();
            average3+=(t6 - t5)/100;

            t7 = System.nanoTime();
            c.sortUsingStringArray("Fjuvbulpqa");
            t8 = System.nanoTime();
            average4+=(t8 - t7)/100;

            d = new CircleList("1000.txt");
            t9 = System.nanoTime();
            d.bubbleSort("Jllogaipgp");
            t10 = System.nanoTime();
            average5+=(t10 - t9)/100;

            t11 = System.nanoTime();
            d.sortUsingStringArray("Jllogaipgp");
            t12 = System.nanoTime();
            average6+=(t12 - t11)/100;
        }

        fw.write( "bubbleSort() for 100 take in average: "+ average1/1000 + " microseconds"+  "\n" + "\n");
        fw.write( "sortUsingStringArray() for 100 take in average: "+ average2/1000 + " microseconds"+  "\n" + "\n");
