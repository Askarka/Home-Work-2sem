 ...
 */
public class AAUnmodifableCollection extends AbstractCollection<Integer>{

  public static void main(String[] args) {
    Collection<Integer> col;
    
    col = new AAUnmodifableCollection();
    ...
    arrList.add(42);
    arrList.add(12);
    col = new AAUnmodifableCollection(arrList);
    for(Integer el : col){
      System.out.println(el);
    }
  ...
  public AAUnmodifableCollection(){
    data = new Integer[DEFAULT_SIZE];
    size = DEFAULT_SIZE;
  }
  
  public AAUnmodifableCollection(Collection<? extends Integer> col){
