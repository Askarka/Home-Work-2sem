...
// */
//public class ToliaNavigableSet<T> extends AbstractSet<T> implements NavigableSet<T> {
//
...
//            if(order * comparator.compare(t, array.get(i)) > 0){
//                flag = false;
//            }
//            else {
//                r = array.get(i);
...
//            n.add(array.get(i));
//        }
//        ToliaNavigableSet<T> set = new ToliaNavigableSet<>(comparator, order);
//        set.array = array;
//        set.size = size;
//        return set;
//    }
...
//            if(order * comparator.compare(array.get(i),t) > 0){
//                array.add(t, i);
//                return true;
//            }
...
//        ToliaNavigableSet<?> that = (ToliaNavigableSet<?>) o;
...
//    @Override
//    public int hashCode() {
//        return Objects.hash(super.hashCode(), array, size, comparator, order);
//    }
//}
