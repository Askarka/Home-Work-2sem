 ...
 */
public class AAModifableCollection extends AbstractCollection<Integer>{

  public static void main(String[] args) {
    Collection<Integer> col;
    
    col = new AAModifableCollection();
    ...
    arrList.add(42);
    arrList.add(12);
    col = new AAModifableCollection(arrList);
    for(Integer el : col){
      System.out.println(el);
    }
  ...
  public AAModifableCollection(){
    data = new Integer[DEFAULT_SIZE];
    size = DEFAULT_SIZE;
  }
  
  public AAModifableCollection(Collection<? extends Integer> col){
